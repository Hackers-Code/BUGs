            ...
            if(receiving==0x2f){
                for(int i=deltareceive; i<received; i++){
                    if(protbufferi[0]){
                        ...
                        if(!(to_receive%25)){
                            if(protbufferi[1]!=40){players.push_back(player(protbufferi[1], protbuffers[0], sf::Color(protbufferi[2], protbufferi[3], protbufferi[4]), protbufferi[5]));cout<<protbufferi[1]<<", ";
                            }
                            protbufferi[1]=data[i];
                            protbuffers[0]="";
                        }else
